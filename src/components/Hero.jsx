    ...
    return (
        <section id="home" className="hero">
            <div className="hero-background">
                ...
                <div className="hero-video-wrapper" style={{ backgroundImage: "url('/images/event-1.webp')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundColor: '#000' }}>
                    <iframe
                ...
                <div className="hero-text">
                    ...
                    >
                        <div className="stat-item">
                            <span className="stat-number"><CountUp end={1200} suffix="+" /></span>
                            <span className="stat-label">Group Members</span>
                        </div>
                        <div className="stat-item">
                            <span className="stat-number"><CountUp end={33} suffix="+" /></span>
